###############################################################################
## Prerequisites:
##  1. Run in PowerShell Console as admin
##  2. winrm is running. See https://til.juliusgamanyi.com/posts/setup-winrm
###############################################################################
...
New-Item -Path C:\tmp\winrm-prep -ItemType Directory -Force
